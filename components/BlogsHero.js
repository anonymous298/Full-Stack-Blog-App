...
const BlogsHero = () => {
  return (
    <>
        <div id="herosubscription" className=' w-[50%] mx-auto flex flex-col justify-center items-center p-3 gap-y-8 mb-15'>
            ...
            <div className=' border-2 w-[75%] flex shadow-[-7px_7px_0px_#000] overflow-hidden'>
